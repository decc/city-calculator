...
places, round-precision = 1]{%
  \Sexpr{as.numeric(as.Quantity(with(ukregco2, sum(CO2[yr == 2010])), "Mt"))}%
...
\Sexpr{as.numeric(as.Quantity(sum(boroughs.co2$CO2[boroughs.co2$yr == 2010]), "Mt"))}%

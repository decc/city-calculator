...
%
% COLOUR
% \definecolor{decc.orange}{rgb}{0.777, 0.320, 0.00}
% \definecolor{decc.blue}{rgb}{0.000, 0.617, 0.887}
%
\title{}
\author{James Geddes}
\begin{document}
%
<<label = set_options, echo = FALSE>>=
options(continue = " ", digits = 3)
require(xtable)
@ 
